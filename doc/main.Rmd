...
if(run.gbm){
  ...
  pred[pred < 0] <- 0
  pred_gbm <- pred
  save(pred_gbm, file="../output/pred_gbm.RData")
}else{
  load("../output/pred_gbm.RData")
}
w <- ifelse(comb_test$perishable == 0, 1, 1.25)
...
```
As the combinations of the predictions from 2nd Stack models Random Forest, and XgBoost do give us better performance, we would like to include this step in our whole model.