...
print(paste0("The best n.trees is ",best_parameter[1],", the best interation.depth is ",best_parameter[2],", and the best shrinkage is ",best_parameter[3]))
if(run.gbm){
...
comb_test_gbm$unit_sales[comb_test_gbm$unit_sales < 0] <- 0
best_score <- sqrt(sum(w * (log(pred + 1) - log(comb_test_gbm$unit_sales + 1))^2)/sum(w))
